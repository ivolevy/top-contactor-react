  ...
  return (
    <section className='footer'>
        ...
        <div className='footerLinks'>
            <p className='footerText'><NavLink className='footerLink' to='/Contractors'>Apply to join as a Top Contractor</NavLink></p>
        ...
        <div className='footerLinks'>
            ...
            <p className='footerText'><NavLink className='privacy' to='/Privacy'>Privacy & Terms</NavLink></p>
        </div>
    </section>
  );
}
